...
export default function InquiriesPage() {
  ...
  const [filters, setFilters] = useState({
    ...
    breakfast: false,
    noPrepayment: false,
    minReviewScore: "any" as "any" | "6" | "7" | "8" | "9",
  ...
  const hotelShopFilters: HotelSearchFilters = useMemo(
    () => ({
      ...
      minReviewScore: (filters.minReviewScore || "any") as HotelSearchFilters["minReviewScore"],
      board: filters.board,
                ...
                <ShopHotelResults
                  ...
                  onFiltersChange={(next) =>
                    setFilters((prev) => ({
                      ...
                      minReviewScore: next.minReviewScore,
                      board: next.board,
                      ...
                      roomFacilities: next.roomFacilities || [],
                      starRatings: next.starRatings || [],
                      mealTypes: next.mealTypes || [],
                      maxDistanceKm: next.maxDistanceKm || "",
                      landmarks: next.landmarks || [],
                      brands: next.brands || [],
                      bedTypes: next.bedTypes || [],
                      onlinePayment: Boolean(next.onlinePayment),
                      maxPrice: next.maxPrice,
                      maxPricePerNight: next.maxPricePerNight || "",
                      refundableOnly: next.refundableOnly,
                      bookableOnly: next.bookableOnly,
                      destinationCodeOnly: next.destinationCodeOnly || "",
                    }))
                  }
                  onSortChange={(key) =>
