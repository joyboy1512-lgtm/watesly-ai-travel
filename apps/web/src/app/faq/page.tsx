...
const FAQ = [
  {
    cat: "طيران",
    q: "هل يمكنني اختيار الذهاب والعودة بشكل منفصل؟",
    a: "نعم. اختر رحلة الذهاب ثم العودة ثم فئة السعر. يمكنك تغيير أحد الاتجاهين دون إعادة البحث بالكامل عند دعم المزج.",
  },
  {
    cat: "فنادق",
