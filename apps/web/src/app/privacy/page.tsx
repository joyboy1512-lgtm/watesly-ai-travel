...
export default function PrivacyPage() {
  return (
    <LegalPageShell title="سياسة الخصوصية" titleKey="privacy">
      ...
      <h2>الرسائل الصوتية</h2>
      <p>
        عند استخدام التسجيل الصوتي داخل المساعد، يُحوَّل الصوت إلى نص على
        الخادم عبر خدمة تحويل آمنة دون إرسال مفاتيح إلى المتصفح. لا نحتفظ
        بالملفات الصوتية بشكل دائم ما لم توافق صراحة وتُحدَّث سياسة الاحتفاظ.
        لا تُسجَّل النصوص الحساسة أو ملفات الصوت في سجلات التشخيص.
      </p>
      <h2>حقوقك</h2>
      <p>
