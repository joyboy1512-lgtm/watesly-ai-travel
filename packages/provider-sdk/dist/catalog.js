...
exports.PROVIDER_CATALOG = [
    ...
    },
    {
        ...
        description: "مجمّع للطيران منخفض التكلفة والداخلي (LCC + Domestic) مثل Ryanair وغيرها",
        capabilities: ["flight"],
        status: "scaffold",
        envKeys: [
        ...
        notes: "Travelfusion يغطي معظم شركات الطيران منخفض التكلفة والداخلي عبر XML API",
    },
    {
        providerKey: "hotelbeds",
        displayName: "Hotelbeds Hotels",
        displayNameAr: "Hotelbeds فنادق",
        description: "API فنادق Hotelbeds APItude فقط (Availability + Content). لا يشمل المواصلات.",
        capabilities: ["hotel"],
        status: "ready",
        envKeys: [
            "HOTELBEDS_API_KEY",
        ...
        notes: "فعّل HOTEL_PROVIDER=hotelbeds مع HOTELBEDS_API_KEY / HOTELBEDS_API_SECRET. مواصلات Hotelbeds مزود منفصل.",
    },
    {
        providerKey: "hotelbeds-transfers",
        displayName: "Hotelbeds Transfers",
        displayNameAr: "Hotelbeds مواصلات",
        description: "API مواصلات Hotelbeds Transfers فقط. يعمل بمفاتيح مستقلة عن الفنادق.",
        ...
        notes: "فعّل TRANSFER_PROVIDER=hotelbeds-transfers مع HOTELBEDS_TRANSFER_API_KEY / SECRET. لا يستخدم مفاتيح الفنادق.",
    },
    {
        providerKey: "hotelbeds-activities",
        displayName: "Hotelbeds Activities",
        displayNameAr: "Hotelbeds أنشطة",
        description: "API أنشطة ومعالم Hotelbeds Activities فقط. يعمل بمفاتيح مستقلة عن الفنادق والمواصلات.",
        ...
        notes: "فعّل ACTIVITY_PROVIDER=hotelbeds-activities مع HOTELBEDS_ACTIVITY_API_KEY / SECRET.",
    },
];
function getCatalogEntry(providerKey) {
    const key = providerKey.trim().toLowerCase();
    const alias = key === "real"
        ? "duffel"
        : key === "hotelbeds_transfers" ||
            ...
            : key === "hotelbeds_activities" ||
                ...
                : key;
    return exports.PROVIDER_CATALOG.find((p) => p.providerKey === alias) || null;
}
