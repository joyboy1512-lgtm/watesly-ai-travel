...
exports.buildMockHotelRateTree = buildMockHotelRateTree;
...
function buildMockHotelRateTree(input) {
    ...
    for (const room of roomVariants(hotel)) {
        ...
        for (const board of BOARD_VARIANTS) {
            ...
            const rate = {
                ...
                boardName: (0, shared_1.boardLabelAr)(board.code),
                net,
                netBasis: "stay",
                currency,
                paymentType,
                ...
                promotions: seed % 3 === 0 && board.code === "BB"
...
//# sourceMappingURL=mock-hotel-rates.js.map