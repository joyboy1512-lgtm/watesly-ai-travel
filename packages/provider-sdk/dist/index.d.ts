...
export { resolveFlightProviderKey, resolveHotelProviderKey, resolveTransferProviderKey, resolveActivityProviderKey, resolveProviderKey, isHotelbedsTransferKey, getFlightProvider, getHotelProvider, getTransferProvider, getActivityProvider, getTravelProvider, } from "./resolve";
...
export { hotelbedsHeaders, hotelbedsSignature, resolveHotelbedsCredentials, resolveHotelbedsTransferCredentials, resolveHotelbedsActivityCredentials, } from "./hotels/hotelbeds-auth";
