import type { ActivityOffer, FlightOffer, HotelOffer, HotelRateOption, MoneyMinor, TransferOffer } from "@watesly-travel/shared";
...
export interface FlightProviderAdapter {
    ...
    createBooking?(offer: FlightOffer, passengers: unknown): Promise<ProviderBookingResult>;
}
...
export interface HotelProviderAdapter {
    ...
    createBooking?(offer: HotelOffer, guests: unknown): Promise<ProviderBookingResult>;
}
...
export interface TransferProviderAdapter {
    ...
    createBooking?(offer: TransferOffer, guests: unknown): Promise<ProviderBookingResult>;
}
...
export interface ActivityProviderAdapter {
    ...
    createBooking?(offer: ActivityOffer, guests: unknown): Promise<ProviderBookingResult>;
}
/**
...
export declare function amountToMinor(amount: string | number, currency?: string): MoneyMinor;
