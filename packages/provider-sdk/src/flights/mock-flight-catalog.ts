...
export const MOCK_AIRLINES: Record<string, MockAirline> = {
...
export const MOCK_ROUTE_MULTIPLIER: Record<string, number> = {
  DXB: 0.55,
  IST: 1.15,
  LHR: 1.85,
  LON: 1.85,
...
export const MOCK_DESTINATION_LABELS: Record<string, string> = {
  DXB: "دبي",
  IST: "إسطنبول",
  LHR: "لندن",
  LON: "لندن",
...
export const MOCK_FLIGHT_TEMPLATES: MockFlightTemplate[] = [
  {
...
export function addMinutesToIsoDate(date: string, minutes: number): {
  isoLocal: string;
  clock: string;
} {
